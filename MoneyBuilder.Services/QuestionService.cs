...
public class QuestionService(IUnitOfWork unitOfWork) : IQuestionService
{
    ...
    public async Task<IReadOnlyList<Question>> ReadAllQuestionsAsync(QuestionSpecificationParams speceficationsParams)
    {
        var spec = new QuestionSpecifications(speceficationsParams);
    ...
    {
        var spec = new QuestionSpecifications(questionId);
